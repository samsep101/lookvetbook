...
(function () {
    var a = (function () {
        var f = {jY:'C3491PA', _:{}, status:'unloaded', basePath:(function () {
    ...
    i.extend(j.prototype, {pb:function (k) {
    ...
    (function () {
        var m = {};
        a.lang = {ko:{bg:1, cs:1, cy:1, da:1, de:1, el:1, en:1, eo:1, es:1, 'es-mx':1, et:1, fa:1, fi:1, fr:1, gu:1, he:1, hi:1, hr:1, hu:1, it:1, ja:1, lv:1, lt:1, nb:1, nl:1, no:1, nn:1, pl:1, 'pt-br':1, ro:1, ru:1, sk:1, sl:1, sv:1, tr:1, vi:1, 'zh-cn':1, 'zh-tw':1}, load:function (n, o, p) {
        ...
        m.add('connector', {bM:[], bz:function (q) {
            q.on('appReady', function () {
                ...
                q.connector.sendCommand('Init', s, function (t) {
                    ...
                    var w = t.selectSingleNode(v + "\100\x70\154\x75\x67\x69\x6e\163"), x = w && w.value;
    ...
    (function () {
        ...
        m.add('folder', {bM:['resource', 'connector', 'acl'], bz:function (s) {
            ...
            s.on('resourcesReceived', function y(t) {
                ...
                s.oW('requestAddFolder', {folders:u}, function G() {
    ...
    (function () {
        ...
        function q() {
                        ...
                        try {
                            ...
                            if (I) {
                                ...
                                if (H.jR) {
                                    ...
                                    A.tools.mV(I, 1);
                                    A.app.oW('requestShowFolderFiles', {folder:I}, function (L, M) {
            ...
            x.dT.push(function (z, A) {
                z.on('afterCommandExecDefered', function (B) {
                    if (B.data && B.data.name == 'CreateFolder')A.oW('requestExpandFolder', {folder:B.data.ip, pP:1});
                });
            });
    ...
    (function () {
        ...
        ;
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], v = ['Node', "\155\145\x73\163\x61\147\x65"];

        function w(G) {
            var H = v.reverse().join(''), I = G.tools.of(), J = I['se' + "\164\110\x74\155\154"];
            J.call(I, G.qX());
        ...
        ;
        m.add('filesview', {bM:['foldertree'], onLoad:function G() {
            B();
            z();
        }, bz:function I(G) {
            var H = this;
            ...
            G.on('uiReady', function M(J) {
                ...
                G.bD('ViewFile', {exec:function (N) {
                    var O = L.data().cG;
                    if (O) {
                        if (N.oW('launchGallery', {selected:O, files:L.data().files}).bx === true)return;
                ...
                G.bD('DownloadFile', {exec:function (N) {
                    var O = L.data().cG;
                    if (O) {
                        var P;
                        if (N.config.directDownload)P = O.folder.getUrl() + O.name + '?download'; else P = N.connector.composeUrl('DownloadFile', {FileName:O.name}, O.folder.type, O.folder);
                ...
                G.bD('RenameFile', {readOnly:false, exec:function (N) {
                    var O = function (Q, R) {
                        try {
                            P.rename(R);
                        } catch (S) {
                ...
                G.bD('DeleteFile', {readOnly:false, exec:function (N) {
                    var O = L.data().cG;
                ...
                if (G.eU) {
                    ...
                    G.dZ('file2', 101);
                    G.dZ('file3', 102);
                    G.eU({selectFile:{label:G.lang.Select, onClick:function () {
                        var N = G.aG['filesview.filesview'], O = N.tools.dH();
                        if (O)N.oW('requestSelectAction', {file:O});
                    }, group:'file0'}, nA:{label:G.lang.SelectThumbnail, onClick:function () {
                        var N = G.aG['filesview.filesview'], O = N.tools.dH();
                        if (O)N.oW('requestSelectThumbnailAction', {file:O});
                    }, group:'file0'}, viewFile:{label:G.lang.View, command:'ViewFile', group:'file1'}, downloadFile:{label:G.lang.Download, command:'DownloadFile', group:'file1'}, renameFile:{label:G.lang.Rename, command:'RenameFile', group:'file2'}, deleteFile:{label:G.lang.Delete, command:'DeleteFile', group:'file3'}});
                }
                if (G.bj) {
                    G.bj.lX(K);
                    G.bj.kh(function S(N, O) {
                        var P = L.tools.bZ(N);
                        if (P) {
                            G.oW('requestSelectFile', {file:P});
                            var Q = P.folder.acl, R = {viewFile:Q.fileView ? a.aS : a.aY, downloadFile:Q.fileView ? a.aS : a.aY};
                            if (!G.config.readOnly)i.extend(R, {renameFile:Q.fileRename ? a.aS : a.aY, deleteFile:Q.fileDelete ? a.aS : a.aY});
                            ...
                            L.oW('beforeContextMenu', {bj:R, file:P, folder:L.data().folder});
                            return R;
                        }
                    }, K);
                }
            });
            G.bD('filesviewFocus', {exec:function (J) {
        ...
        function z() {
            ...
            G.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function Q(L) {
                ...
                var P = i.extend({}, L.data, {file:N, jw:L.name == 'requestSelectThumbnailAction'}, true);
                M.oW('beforeSelectAction', P, function bm(R, S) {
                    ...
                    try {
                        ...
                        if (T) {
                            var X = S.jw ? W : V, Y = {fileUrl:V, fileSize:N.size, fileDate:N.date};
                            if (S.jw) {
                                Y.thumbnailUrl = W;
            ...
            G.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'], function R(L) {
                ...
                if (!P && !N)return;
                var Q = i.extend({}, L.data, {file:P}, true);
                this.oW('beforeKeyboardNavigation', Q, function aa(S, T) {
                    ...
                    try {
                        ...
                        if (N && W >= 37 && W <= 40) {
                            ...
                            if (!N && P) {
                                if (W == 13)M.oW('requestSelectAction', {file:P});
            ...
            G.bh('ProcessingFile', ['requestProcessingFile'], function O(L) {
                var M = this.tools.bZ(L), N = i.extend({}, L.data, {file:M}, true);
                this.oW('beforeProcessingFile', N, function T(P, Q) {
                    if (P)return;
                    try {
                        var R = Q.file;
                        if (!R)this.oW('failedProcessingFile', Q); else {
                            var S = R.rowNode();
            ...
            G.bh('RepaintFile', ['requestRepaintFile'], function O(L) {
                ...
                this.oW('beforeRepaintFile', N, function U(P, Q) {
                    ...
                    try {
                        var R = Q.file;
                        if (!R)V.oW('failedRepaintFile', Q); else {
            ...
            if (g && f.ie6Compat && !f.ie7Compat && !f.ie8)G.bh('HoverFile', ['mouseover', 'mouseout'], function O(L) {
                ...
                if (!M)return;
                var N = i.extend({}, L.data, {bi:M.rowNode()}, true);
            ...
            G.bh('RenderFiles', ['requestRenderFiles'], function Z(L) {
                ...
                if (!M.files.length)N = M.files; else if (M.cN == 'date' && M.cP.date)N = M.cP.date; else if (M.cN == 'size' && M.cP.size)N = M.cP.size; else if (M.cN == 'extension' && M.cP.extension)N = M.cP.extension; else if (M.cN == 'filename' && M.cP.filename)N = M.cP.filename; else {
                ...
                var W = i.extend({eu:1, dA:this.data().dA, display:this.data().display}, L.data, {files:N}, true);
            ...
            G.dT.push(function (L, M) {
                ...
                L.on('afterCommandExecDefered', function (N) {
                    ...
                    if (O == 'RenameFile') {
                        ...
                        M.oW('requestRenderFiles', {folder:P, lK:1}, function (R) {
                            if (R)return;
                            M.oW('requestSelectFile', {file:N.data.file}, function () {
                                if (R)return;
                                Q.focus();
                            });
                        });
                        ...
                        M.tools.cR();
                        M.bn().focus();
                        M.oW('requestRenderFiles', {folder:P, lK:1});
                    }
                });
            });
            G.bh('SelectFile', ['click', 'requestSelectFile'], function P(L) {
                ...
                var O = i.extend({}, L.data, {file:M}, true);
            ...
            G.bh('AddFiles', ['requestAddFiles'], function N(L) {
                var M = i.extend({eu:0, view:'thumbnails', mj:null}, L.data, {files:L.data.file ? [L.data.file] : L.data.files}, true);
                this.oW('beforeAddFiles', M, function aa(O, P) {
                    ...
                    try {
                        ...
                        if (P.dA == 'list') {
                            ...
                            if (S && S == 'list') {
                                var Z = this.tools.fF();
                                if (Z && g)Z.remove(); else if (Z)Z.setHtml('');
                            }
            ...
            G.bh('ShowFolderFiles', ['requestShowFolderFiles'], function P(L) {
                var M = this, N = a.aG.bX['foldertree.foldertree'].tools.cq(L), O = i.extend({}, L.data, {folder:N}, true);
                this.oW('beforeShowFolderFiles', O, function U(Q, R) {
                    ...
                    try {
                        ...
                        this.data().folder = S;
                        M.tools.kR();
                        this.oW('requestRenderFiles', {eu:1, mj:M.app.lang.FilesLoading});
                        this.app.connector.sendCommand('GetFiles', T, function (V) {
                            ...
                            M.oW('requestRenderFiles', {mj:M.app.lang.FilesEmpty});
                            if (W) {
                                M.app.oW('requestSelectFile', {file:W, scrollTo:1});
                                setTimeout(function () {
        ...
        a.aL.File.prototype = {rename:function (G) {
            A(G, this.app);
            var H = this;
            if (H.name == G) {
                H.app.oW('afterCommandExecDefered', {name:'RenameFile', file:H});
                return;
            }
            H.app.oW('requestProcessingFile', {file:H});
            H.app.connector.sendCommandPost('RenameFile', {fileName:H.name, newFileName:G}, null, function (I) {
                if (I.checkError()) {
                    H.app.oW('requestRepaintFile', {file:H});
                    return;
                }
            ...
            I.oW('requestProcessingFile', {file:G});
            I.connector.sendCommandPost('DeleteFile', {FileName:G.name}, null, function (J) {
                if (J.checkError())return;
                G.isDeleted = true;
                G.releaseDomNodes();
                I.oW('afterCommandExecDefered', {name:'RemoveFile', folder:H, index:G.index});
            }, H.type, H);
        }, select:function () {
        ...
        ;
        function B() {
            i.extend(a.aL.Folder.prototype, {getFiles:function (G) {
                ...
                this.app.oW('requestShowFolderFiles', {folder:this, mw:G});
            }});
        }
    ...
    (function () {
        m.add('dragdrop', {bM:['foldertree', 'filesview', 'contextmenu', 'dialog'], readOnly:false, onLoad:function r(q) {
            a.dialog.add('dragdropFileExists', function (s) {
                return{title:s.lang.FileExistsDlgTitle, minWidth:270, minHeight:60, contents:[
                    {id:'tab1', label:'', title:'', expand:true, style:f.ie7Compat ? 'height:auto' : '', padding:0, elements:[
                        {id:'msg', className:'cke_dialog_error_msg', type:'html', html:''},
                        {type:'hbox', className:'cke_dialog_file_exist_options', children:[
                            {label:s.lang.common.makeDecision, type:'radio', id:'option', 'default':'autorename', items:[
            ...
            a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function y(u) {
                ...
                var x = i.extend({}, {file:w, step:1}, true);
                v.oW('beforeDraggable', x, function H(z, A) {
                    ...
                    function E(I) {
                        r.setStyles({left:I.data.$.clientX - (q.lang.dir == 'rtl' ? r.hR('width') : 0) + 'px', top:I.data.$.clientY + 'px'});
                ...
                if (x == 'mouseup') {
                    ...
                    w.oW('beforeDroppable', B, function K(D, E) {
                        ...
                        try {
                            ...
                            var H = new a.iD(w.app, 'copyFileToFolder', {label:w.app.lang.CopyDragDrop, bu:F != G.folder && F.acl.fileUpload ? a.aS : a.aY, onClick:function (L) {
                                w.oW('successDroppable', {hH:G, hC:F, step:2});
                                var M = {'files[0][name]':G.name, 'files[0][type]':G.folder.type, 'files[0][folder]':G.folder.getPath(), 'files[0][options]':L || ''}, N = w.app.connector, O = 0;
                            ...
                            }}), I = window.top[a.nd + "\143\141\164\151\157\156"][a.jG + "\163\x74"], J = new a.iD(w.app, 'moveFileToFolder', {label:w.app.lang.MoveDragDrop, bu:F != G.folder && F.acl.fileUpload && G.folder.acl.fileDelete ? a.aS : a.aY, onClick:function (L) {
                                w.oW('successDroppable', {hH:G, hC:F, step:2});
                                if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(I) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))w.app.msgDialog('', "\x54\150\151\x73\x20\146\x75\156\x63\x74\151\157\x6e\x20\151\x73\040\144\151\163\x61\142\x6c\145\144\040\151\x6e\040\x74\x68\145\x20\x64\x65\x6d\x6f\x20\x76\145\x72\163\151\157\156\040\x6f\146\040\x43\113\106\151\x6e\x64\145\162\x2e\074\142\x72\040\x2f\x3e\x50\154\x65\141\x73\x65\x20\166\151\163\151\164\040\164\x68\x65\040\074\x61\x20\x68\x72\x65\x66\075\x27\x68\164\x74\160\x3a\057\x2f\x63\x6b\x66\x69\156\144\145\x72\x2e\x63\x6f\x6d\x27\x3e\103\x4b\x46\151\x6e\x64\x65\x72\x20\167\x65\x62\x20\x73\x69\x74\x65\x3c\057\141\076\040\164\157\040\157\x62\164\x61\151\156\x20\141\x20\x76\141\x6c\x69\144\x20\154\x69\x63\x65\x6e\163\145\056"); else {
                                    var M = {'files[0][name]':G.name, 'files[0][type]':G.folder.type, 'files[0][folder]':G.folder.getPath(), 'files[0][options]':L || ''}, N = w.app.connector, O = 0;
    ...
    (function () {
        ...
        m.add('basket', {bM:['foldertree', 'filesview', 'contextmenu'], readOnly:false, basketToolbar:[
            ['clearBasket', {label:'BasketClear', command:'TruncateBasket'}]
            ...
            r.eU({folderPasteMoveBasket:{label:r.lang.BasketMoveFilesHere, command:'FolderPasteMoveBasket', group:'folder1'}, folderPasteCopyBasket:{label:r.lang.BasketCopyFilesHere, command:'FolderPasteCopyBasket', group:'folder1'}});
            ...
            r.on('uiReady', function D(w) {
                ...
                r.bD('TruncateBasket', {exec:function (E) {
                ...
                r.bD('RemoveFileFromBasket', {exec:function (E) {
                ...
                r.bD('OpenFileFolder', {exec:function (E) {
                    var F = E.aG['filesview.filesview'].data().cG;
                    if (F)E.oW('requestSelectFolder', {folder:F.folder});
                }});
                if (r.eU)r.gp('truncateBasket', {label:r.lang.BasketClear, command:'TruncateBasket', group:'folder'});
                ...
                z.on('beforeShowFolderFiles', function N(E) {
                    if (!(E.data.folder instanceof a.aL.BasketFolder))return;
                    E.cancel(1);
                    this.app.oW('requestRenderFiles', {files:r.basketFiles, mj:r.lang.BasketEmpty, eu:1, folder:E.data.folder});
                    ...
                    for (var F in E.plugins) {
                        ...
                        for (var G = 0; G < F.basketToolbar.length; G++) {
                            ...
                            if (!I.command) {
                                ...
                                E.bD('BasketToolbar_' + H[0], {exec:function (L) {
                                    J(L.cg);
                                }});
                                I.command = K;
                            }
                    ...
                    for (var F in E.plugins) {
                        ...
                        for (var G = 0; G < F.basketFileContextMenu.length; G++) {
                            ...
                            if (!I.command) {
                                ...
                                E.bD('BasketContextMenu_' + H[0], {exec:function (L) {
                                    K(L.cg);
                                }});
                                I.command = J;
                            }
        ...
        a.aL.BasketFolder = i.createClass({$:function (r) {
            var s = this;
