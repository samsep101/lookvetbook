      ...
      <div class="head-info flo">
        ...
        <p>
          ...
          <span itemprop="geo" itemscope itemtype="http://data-vocabulary.org/Geo"
                style="display: block; position: absolute; width: 1px; height: 1px; overflow: hidden;">
    ...
    <div class="dobromed-banner">
      <table>
        ...
        <tr>
          ...
          <td>Запишись сейчас к <span class="service-link" data-specialty-id="26"><a class="like_service_ul"
                                                                                     href="#our-doctors">рентгенологу</a></span>
            с<br/>помощью <b>Look<span style="color: #e23a79;">Med</span>Book</b></td>
        ...
        <tr>
          ...
          <td align="center" class="td-phone">
            ...
            <div class="info-phone">8 (495) 215-09-27</div>
          </td>
        </tr>
      </table>
    </div>
