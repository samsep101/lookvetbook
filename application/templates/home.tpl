    ...
    <div id="wrapper" class="wrap">
        <div id="header">
            ...
            <div class="sp-links right-links">
                ...
                <span class="phone"><small>(<?php echo SITE_PHONE_CODE; ?>)</small> <a href="tel:+7(<?php echo SITE_PHONE_CODE; ?>)<?php echo SITE_PHONE; ?>"><?php echo SITE_PHONE; ?></a> <span class="flo"></span><span class="calltime">с 09 до 21</span></span>
