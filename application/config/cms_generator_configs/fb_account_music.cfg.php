<?php
    $cms_fb_account_music = array(
        'table'     => DB_PREFIX . 'fb_account_music',
        'title'     => 'Facebook.com аккаунт - музыка',
        'fields'    => array(
            'id'            => 'index',
            'fb_account_id' => array(
                'type'        => 'category',
        ...
        'generator' => array(
            ...
            'list'   => array(
                ...
                'title'   => 'Список музыки аккаунтов из Facebook.com',
                'sort_by' => array(
                    array(
                        'field' => 'name',
                        'desc'  => 'ASC'
    ...
    CmsGeneratorConfigRegister::add('fb_account_music', $cms_fb_account_music);