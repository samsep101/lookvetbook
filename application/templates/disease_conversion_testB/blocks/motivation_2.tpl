<div class="disease-doc-block">
    <div class="col-10 disease-doc-text avatar_buttons">
        <p>
            После прогулок на природе необходимо осматривать складки кожных покровов и волосистую часть головы на наличие клеща.
            В случае его обнаружения не занимайтесь самолечением - незамедлительно обратитесь к инфекционисту.
            <br>
            <a class="btn-appoint" href="#record-to-the-doctor-popup-1635" onclick="$('.disease-doc-hide2').slideToggle('slow');" style="width: 250px">Записаться на прием</a>
        </p>
    </div>
    <div class="col-2 disease-doc-image">
        <div class="avatar">
            <img src="//lookmedbook.ru/media/upload/clinic/license/74x111-crop-1455531640-tYF2BR36R6.jpg">
        </div>
    </div>
    <br clear="all">
    <div align="right">
        Сёмина  Ирина  Викторовна (Врач инфекционист)
    </div>
</div>
<div class="disease-doc-hide2" style="display:none;padding-left: 50px">
    ...
    <form action="/ajax/recordToTheVisit" method="POST" class="recordPopupForm linkMapper" rel=".recordFormResult" onComplete="recordComplete()">
        ...
        <div class="row flo m-b-20">
            ...
            <div class="inner-top-info" style="text-align: center;font-size: 1.2em;">
                Мы всегда рады вам помочь! <span class="info-phone">8 495 215 09 27</span>
            </div>
        </div>
