...
define('SITE_URL', SITE_SCHEME . "://lookvetbook.ru");
define('SITE_DOMAIN', "LookVetBook.ru");
define('SITE_NAME', "LookVetBook");
define('SHOP_ENABLE', 1);
define('RELEASE_NUMBER', 43);
define('SITE_PHONE_CODE', '495');
define('SITE_PHONE', '215-09-07');
define('CSS_DIR', 'vet');
define('PAGE_TITLE', 'Портал ветеринарных услуг в ');
define('JUR_ADDRESS', 'Гамсоновский переулок, 2');
define('JUR_ADDRESS_FULL', '115191, г.Москва, Гамсоновский переулок, д.2, офис 200');
define('CONTENT_DISEASE_URL', 'http://admin:Eghfd24Kzq@content.'.SITE_DOMAIN.'/media/xml/Test.xml');
