...
class DoctorController extends BaseController
{
    ...
    public function index($specialty_alias = NULL)
 {
  ...
  public function ajaxSearch() {
    ...
    $specialty_name = SpecialtyHelper::getNameByCount($doctor_search_params->specialty_id, $doctors_total_count);    $this->ajaxSearch__view_params($doctor_search_params->specialty_id, isset($specialty->id) ?$specialty->id: null, $doctors, $doctor_search_params->purpose_of_visit_id);
