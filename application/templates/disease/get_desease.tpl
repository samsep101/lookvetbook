...
<div class="inner">
	<div class="about-ilness-content flo">
		<div class="main-column">
			...
			<div class="desease-phone" style="width: 100%; text-align: right; float: none"><a style="color: black; text-decoration: none" href="tel:+7(<?=SITE_PHONE_CODE?>)<?=SITE_PHONE?>">Мы найдём Вам врача +7 (<?php echo SITE_PHONE_CODE; ?>) <?php echo SITE_PHONE; ?></a></div>
