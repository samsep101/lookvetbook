...
<div class="magazine inner-2 flo">
    ...
    <div class="block_left" style="width: auto; float: none;">
        ...
        <?php if(isset($product_category) && $product_category && $product_category->id == 1434): ?>
            ...
            <div class="adv_text">
                <p class="showme">
                    <strong>Фосфоглив или Эссливер: сравнение</strong>
                </p>
                <p class="showme">
                ...
                <a onclick="$('.adv_text p, .adv_text div').show(); $(this).hide()">Читать далее</a>
                <p>
                ...
                <p>
                    <strong>Различия в составе</strong>
                </p>
                <p>
                ...
                <p>
                    <strong>Различия в показаниях</strong>
                </p>
                <p>
