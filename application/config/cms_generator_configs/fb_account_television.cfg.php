<?php
    $cms_fb_account_television = array(
        'table'     => DB_PREFIX . 'fb_account_television',
        'title'     => 'Facebook.com аккаунт - ТВ',
        'fields'    => array(
            'id'            => 'index',
            'fb_account_id' => array(
                'type'        => 'category',
        ...
        'generator' => array(
            ...
            'list'   => array(
                ...
                'title'   => 'Список ТВ аккаунтов из Facebook.com',
                'sort_by' => array(
                    array(
                        'field' => 'name',
                        'desc'  => 'ASC'
    ...
    CmsGeneratorConfigRegister::add('fb_account_television', $cms_fb_account_television);