<div class="disease-doc-block">
    <div class="col-10 disease-doc-text avatar_buttons">
        <p>
            Если высокая температура на фоне простудных симптомов держится более 3 дней, не затягивайте с визитом к терапевту. Чем раньше вы начнете лечение, тем легче будет протекать заболевание.
            <br>
    ...
    <div class="col-2 disease-doc-image">
        <div class="avatar">
            <img src="//lookmedbook.ru/media/upload/clinic/license/74x111-crop-1380030825-2AFBa6fTSY.jpg">
        </div>
    </div>
    <br clear="all">
    <div align="right">
        Иванов  Евгений  Владимирович (Врач терапевт)
    </div>
</div>
