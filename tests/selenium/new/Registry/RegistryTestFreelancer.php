...
{
    public function test_REGISTRY_13_doctors_search ()
    {
    ...
    public function test_REGISTRY_21_delete_photo ()
    {
        $this->freelancerLogin();
    ...
    public function test_REGISTRY_44_clinic_specialties ()
    {
        ...
        $this->waitForTextPresent("Данные успешно сохранены");
        $this->waitForPageToLoad();
        $this->clickAndWait("//a[contains(text(),'Услуги')]");
    ...
    public function test_REGISTRY_49_delete_photo ()
    {
        $this->freelancerLogin();
        $this->open("/registry/clinic/photos?clinic_id=3");
        $this->click("css=span.delete-photo-button");
        $this->assertElementNotPresent("css=#image");
        $this->click("name=save");
        sleep(6);
    ...
    public function test_REGISTRY_63_clinic_type_change ()
    {
        $this->freelancerLogin();
        $this->open("/registry/clinic/information?clinic_id=2");
    ...
    public function test_REGISTRY_66 ()
    {
