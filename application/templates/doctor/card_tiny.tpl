...
<script>
    $(document).ready(function(){
        <?php $visits_page_flag = 1; ?>
        block_controller = new VisitRemindBlockController(<?php echo $visit->getUniqueId(); ?>, <?php echo $visits_page_flag ; ?>, <?php echo $unique_id; ?>);
...
<div class="visit-remind-block" id="visit-remind-block-<?php echo $unique_id; ?>">
    <div class="info-card info-card-gr flo">
        ...
        <?php if (isset($leave_review) && ($leave_review == 1)): ?>
        ...
        <div class="descr">
            <?php if ($visit->doctor_id && $visit->doctor_id != DoctorModel::RESERVED_DOCTOR_SLOT):?>
                <p class="name"><a href="<?php echo DoctorPageLinkViewHelper::getLink($visit->doctor); ?>"><span class="post"><?php echo $visit->doctor->specialties_names; ?></span><?php echo $visit->doctor->full_name; ?></a></p>
            ...
            <?php if ($visit->clinic_id):?>
                <div class="location">
                    <p><strong><a href="<?php echo ClinicPageLinkViewHelper::getLink($visit->clinic); ?>"><?php echo $visit->clinic_name; ?></a></strong> <br>
