<?php
    $cms_fb_account_book = array(
        'table'     => DB_PREFIX . 'fb_account_book',
        'title'     => 'Facebook.com аккаунт - книги',
        'fields'    => array(
            'id'            => 'index',
            'fb_account_id' => array(
                'type'        => 'category',
        ...
        'generator' => array(
            ...
            'list'   => array(
                ...
                'title'   => 'Список книг аккаунтов из Facebook.com',
                'sort_by' => array(
                    array(
                        'field' => 'name',
                        'desc'  => 'ASC'
    ...
    CmsGeneratorConfigRegister::add('fb_account_book', $cms_fb_account_book);