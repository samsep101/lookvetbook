<?php
    class LandingLoginClinicPageTest extends BaseSeleniumTest
    {
        ...
        protected function landingLogin()
        {
            ...
            sleep(2);
            $this->assertTrue($this->isElementPresent('css=div.clinic-landing'));
            //$this->assertFasle($this->isElementPresent('id=landing-popup-registration'));
        }
