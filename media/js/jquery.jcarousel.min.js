...
(function (t) {
    ...
    t.jCarousel.plugin("jcarousel", {animating: !1, tail: 0, inTail: !1, resizeTimer: null, lt: null, vertical: !1, rtl: !1, circular: !1, underflow: !1, _options: {list: function () {
        ...
        return this.circular = "circular" === this.options("wrap"), this.underflow = !1, i.size() > 0 ? (this._prepare(i), this.list().find("[data-jcarousel-clone]").remove(), this._items = null, this.underflow = this._fullyvisible.size() >= this.items().size(), this.circular = this.circular && !this.underflow, this.list().css(this.lt, this._position(i) + "px")) : this.list().css({left: 0, top: 0}), this
    }, list: function () {
        if (null === this._list) {
        ...
        var i, e = this, r = this.list().position()[this.lt], n = t(), o = !1, l = this.vertical ? "bottom" : this.rtl ? "left" : "right";
        ...
        if (n.relative) {
            var o, l, a, h, u, c, f = this.items().size() - 1, d = Math.abs(n.target), _ = this.options("wrap");
            if (n.target > 0) {
                var p = this.index(this._last);
                if (p >= f && this.tail)this.inTail ? "both" === _ || "last" === _ ? this._scroll(0, e, r) : this._scroll(Math.min(this.index(this._target) + d, f), e, r) : this._scrollTail(e, r); else if (o = this.index(this._target), this.underflow && i === f && ("circular" === _ || "both" === _ || "last" === _) || !this.underflow && p === f && ("both" === _ || "last" === _))this._scroll(0, e, r); else if (a = o + d, this.circular && a > f) {
            ...
            } else if (this.inTail)this._scroll(Math.max(this.index(this._first) - d + 1, 0), e, r); else if (l = this.index(this._first), o = this.index(this._target), h = this.underflow ? o : l, a = h - d, 0 >= h && (this.underflow && "circular" === _ || "both" === _ || "first" === _))this._scroll(f, e, r); else if (this.circular && 0 > a) {
                for (c = a, u = this.items().get(0); 0 > c++;) {
                    ...
                    var m = s(this.list().css(this.lt)), v = this.dimension(u);
        ...
        var n = this._position(i), o = s(this.list().css(this.lt));
        ...
        if (r && s !== !1) {
            ...
            if (t.isFunction(r))r.call(this, i, function () {
                ...
                var o = "object" == typeof r ? t.extend({}, r) : {duration: r}, l = o.complete;
                o.complete = function () {
        ...
        var e, r, n = this.index(i), o = n, l = this.dimension(i), a = this.clipping(), h = this.vertical ? "bottom" : this.rtl ? "left" : "right", u = {target: i, first: i, last: i, visible: i, fullyvisible: a >= l ? i : t()};
        if (this.options("center") && (l /= 2, a /= 2), a > l)for (; ;) {
        ...
        var i = this._first, s = i.position()[this.lt];
    ...
    t.jCarousel.plugin("jcarouselPagination", {_options: {perPage: null, item: function (t) {
        ...
        var l = this, a = this._element, h = this.options("item");
        this._clear(), t.each(this._pages, function (i, s) {
            var e = l._items[i] = t(h.call(l, i, s));
            a.append(e), t.fn.jcarouselControl && e.jcarouselControl({carousel: l.carousel(), target: s.eq(0)})
        })
    }, items: function () {
        return this._items
    }, _clear: function () {
