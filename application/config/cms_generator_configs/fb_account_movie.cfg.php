<?php
    $cms_fb_account_movie = array(
        'table'     => DB_PREFIX . 'fb_account_movie',
        'title'     => 'Facebook.com аккаунт - видео',
        'fields'    => array(
            'id'            => 'index',
            'fb_account_id' => array(
                'type'        => 'category',
        ...
        'generator' => array(
            ...
            'list'   => array(
                ...
                'title'   => 'Список видео аккаунтов из Facebook.com',
                'sort_by' => array(
                    array(
                        'field' => 'name',
                        'desc'  => 'ASC'
    ...
    CmsGeneratorConfigRegister::add('fb_account_movie', $cms_fb_account_movie);