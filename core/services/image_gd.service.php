    ...
    class ImageGd
    {
        ...
        function createFromFile()
        {
            switch ($this->imageType) {
                case 'gif':
                    return imagecreatefromgif($this->srcPath);
                case 'jpeg':
                    return imagecreatefromjpeg($this->srcPath);
                case 'png':
                    return imagecreatefrompng($this->srcPath);
                case 'wbmp':
                    return imagecreatefromwbmp($this->srcPath);
            }
        }
