<?php
    $cms_fb_account_interes = array(
        'table'     => DB_PREFIX . 'fb_account_interes',
        'title'     => 'Facebook.com аккаунт - интересы',
        'fields'    => array(
            'id'            => 'index',
            'fb_account_id' => array(
                'type'        => 'category',
        ...
        'generator' => array(
            ...
            'list'   => array(
                ...
                'title'   => 'Список интересов аккаунтов из Facebook.com',
                'sort_by' => array(
                    array(
                        'field' => 'name',
                        'desc'  => 'ASC'
    ...
    CmsGeneratorConfigRegister::add('fb_account_interes', $cms_fb_account_interes);