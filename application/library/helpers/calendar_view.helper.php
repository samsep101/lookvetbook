...
OEM;
	...
	public static function chooseInputDate($fieldName="date") {
		
		$arr=<<<OEM
		
		<script src="/media/helpers/calendar/calendar_ru.js"></script>
		<input type="button" name="form[{$fieldName}]" id="{$fieldName}" value="Выбрать дату" onfocus="this.select();lcs(this)" onclick="event.cancelBubble=true;this.select();lcs(this)">
